...
const AccessoriesTwo = () => {
  ...
  return (
    <>
      <section className="container flex flex-wrap pb-4 text-[#3E3E3E]">
        {data.map((item, index) => {
          return (
